                            ...
                            <div class="form-group col-xl-3 col-md-3 col-sm-12">
                                <div class="d-flex justify-content-around">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input name="answer" value="A" class="custom-control-input" id="a" type="radio">
                                        <label class="custom-control-label" for="a">A</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input name="answer" value="B" class="custom-control-input" id="b" type="radio">
                                        <label class="custom-control-label" for="b">B</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input name="answer" value="C" class="custom-control-input" id="c" type="radio">
                                        <label class="custom-control-label" for="c">C</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input name="answer" value="D" class="custom-control-input" id="d" type="radio">
