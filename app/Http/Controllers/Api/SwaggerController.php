 ...
 * @link    http://localhost/colingual/api/
 */
 ...
 * @OA\Info(
 *     version="3.1",
 *     title="colingual Project REST Service",@OA\Contact(name="colingual", url="http://localhost/colingual/")
 * )
 * @OA\Server(
 *     description="Local Server",
 *     url="http://localhost/colingual/api/"
 * ),
 * @OA\Server(
